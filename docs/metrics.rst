...
.. csv-table::
	...
	"platform_vmstat", "Virtual Memory stats based on /proc/vmstat - all possible keys", "yes", "numeric",  "counter", "/proc filesystem", "key"
	"platform_node_vmstat", "Virtual Memory stats based on /sys/devices/system/node/nodeX/vmstat", "yes", "numeric",  "counter", "/proc filesystem", "numa_node, key"
