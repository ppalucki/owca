...
.. csv-table::
	...
	"platform_zoneinfo", "Dynamic metric all keys based on /proc/zoneinfo group by node (only normal zone)", "yes (zoneinfo option)", "numeric",  "gauge", "/proc filesystem", "numa_node, key"
