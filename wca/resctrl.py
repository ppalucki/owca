...
class ResGroup:
    ...
    def get_measurements(self, mongroup_name, mb_monitoring_enabled,
        ...
        measurements = {}
        if mb_monitoring_enabled:
            measurements[MetricName.TASK_MEM_BANDWIDTH] = mbm_total
            measurements[MetricName.TASK_MEM_BANDWIDTH_LOCAL] = mbm_local
            measurements[MetricName.TASK_MEM_BANDWIDTH_REMOTE] = mbm_total - mbm_local
        if cache_monitoring_enabled:
            measurements[MetricName.TASK_LLC_OCCUPANCY] = llc_occupancy
        return measurements
